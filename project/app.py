...
def get_image_url(name):
    ...
    return png_url  # return defult png
...
# Streamlit UI Config
# ---------------------------
st.set_page_config(page_title="SmartMenu", layout="wide")
st.title("🍽️ SmartMenu")
...
# ===========================
if page == "Home":
    st.subheader("✨ Welcome to SmartMenu")
    st.write("Use the navigation bar above to explore menu, get suggestions, view cart, and checkout.")
...
# ============================================
    ...
    # use pairing_module produce top 3 recommendation
